<template>
	<view>
		...
		<list-item-card :list="list" @click="goDetail" btnText="我要报名" isApplyText="查看详情" isApplyEndText="报名已结束"
			:isActivity="true"></list-item-card>
			...
			getCityActivityData() {
				...
				uni.getLocation({
					success: async function(res) {
						...
						let response = await _this.getCurrentCity({
							longitude,
							latitude
						})
